            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.box}>
                    <div className={styles.filter}>
                        <div className={clsx(styles.filter_item, { [styles.active]: true })}>Tất cả</div>
                        <div className={clsx(styles.filter_item, { [styles.active]: false })}>Chờ xác nhận</div>
                        <div className={clsx(styles.filter_item, { [styles.active]: false })}>Đang chuẩn bị</div>
                        <div className={clsx(styles.filter_item, { [styles.active]: false })}>Đang giao</div>
                        <div className={clsx(styles.filter_item, { [styles.active]: false })}>Đã nhận</div>
                        <div className={clsx(styles.filter_item, { [styles.active]: false })}>Đã hủy</div>
                    </div>
                    <div className={styles.item}>
                        <div className={styles.item_top}>
                            <div className={styles.item_top_head}>
                                ...
                                <div className={styles.item_top_head_right}>Chờ xác nhận | Đã thanh toán</div>
                            </div>
                            <div className={styles.item_top_body}>
                                <div className={styles.item_top_body_item}>
                                    <img
                                    ...
                                    <div className={styles.item_top_body_info}>
                                        <div className={styles.item_top_body_info_nameAndPrice}>
                                            <div className={styles.item_top_body_info_name}>
                                                Áo thun unisex nam nữ localbrand blokecore Outerity Sporty Basic
                                            </div>
                                            <div className={styles.item_top_body_info_price}>₫150,000</div>
                                        </div>
                                        <div className={styles.item_top_body_info_classification}>
                                            Phân loại hàng: Đen | S
                                        </div>
                                        <div className={styles.item_top_body_info_quantity}>x2</div>
                                    </div>
                                </div>
                        ...
                        <div className={styles.item_bottom}>
                            <div className={styles.item_bottom_price}>
                                ...
                                <div className={styles.item_bottom_price_number}>₫49.500</div>
                            </div>
                            <button className={styles.item_bottom_btn}>Hủy đơn</button>
                        </div>
                    </div>
